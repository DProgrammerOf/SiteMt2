...
<div class="container bg-dark-1">
	...
	<div class="row">
		...
		<div class="col-12 col-md-12" style="text-align:center;padding-left:0px;">
			<h2>Alterar/Ver 
			<br>Senha de Apagar Personagem</h2>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-12 col-md-6" style="text-align:center;">
			<form class="formCont" action="" method="POST" name="novo_email" id="novo_email">
					<div class="row form">
					{{ csrf_field() }}
							...
							<div class="col-6 col-md-6">
								<input name="password_safebox_atual" type="text" id="password_safebox_atual" size="7" maxlength="7" autocomplete="mt2live-in-armazem-atual" />
							</div>
							...
							<div class="col-6 col-md-6" style="text-align: center;">
								Nova senha de apagar char:
							</div>
							<div class="col-6 col-md-6">
								<input name="social_id_novo" type="text" id="social_id_novo" size="7" maxlength="7" required="">
							</div>
		...
		<div class="col-12 col-md-6" style="text-align:center;">
			<form class="formCont" action="{{ URL::route('painelusuariogerarcodigopessoalpost') }}" method="POST" name="novo_codperso" id="novo_codperso">
					<div class="row form">
							{{ csrf_field() }}
							<div class="col-12 col-md-12" style="text-align: center;font-size:13px;">
								Pedido: <font color="red">(Senha Apagar Char)</font>
							</div>

							<div class="col-12 col-md-12" style="text-align: center;font-size:13px;">
								uma nova senha: (codigo pessoal) gerada através do nosso sistema!
							</div>
